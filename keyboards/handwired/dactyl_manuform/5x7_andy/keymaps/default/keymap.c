...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7_ANDY(
        // left hand
        KC_BTN1, KC_BTN2,   KC_1,    KC_2,    KC_3,   KC_4,   KC_5,
        KC_NO,    KC_NO,    KC_Q,    KC_W,   KC_F,   KC_P,   KC_V,
        KC_NO,    KC_ESC,   KC_A,    KC_R,   KC_S,   KC_T,   KC_G,
        KC_NO,   KC_NO,    KC_Z,    KC_X,   KC_C,   KC_D,    KC_B,
                                    KC__VOLDOWN,   KC__VOLUP,
                                                  LT(_FN, KC_SPC), KC_BSPC,
                                                           KC_TAB, KC_NO,
                                                           KC__VOLDOWN,   KC__VOLUP,
        // right hand
