...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LEFT, KC_RGHT, PST_FND, CPY_CUT, TAB_NUM, SPC_CTL, BSP_ALT, TD(MUX), ENT_NAV, NUM_SYM, TD(WIN), SLAYER, KC_DOWN, KC_UP
  ),
  ...
  [_SHORTCUT] = LAYOUT(
    ...
    KC_CAPS, AUDACIT, XXXXXXX, FINDER,  XXXXXXX, CHROME,                   MSCORE,  NOTES,   XXXXXXX, ITERM,   OUTLOOK, KC_PSCR,
  ...
  [_NUMSYM] = LAYOUT(
    ...
    XXXXXXX, KC_LBRC, KC_RBRC, KC_HASH, KC_CIRC, KC_PERC,                   KC_BSLS, KC_7,  KC_8,    KC_9,    KC_PLUS, KC_TILD,
    XXXXXXX, KC_LPRN, KC_RPRN, KC_EXLM, KC_DLR,  KC_ASTR,                   KC_MINS, KC_4,  KC_5,    KC_6,    KC_EQL,  KC_GRV,
    _______, KC_LCBR, KC_RCBR, KC_PIPE, KC_AMPR, KC_AT,   XXXXXXX, XXXXXXX, KC_UNDS, KC_1,  KC_2,    KC_3,    KC_DOT,  _______,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_DEL,  KC_TILD, XXXXXXX, KC_0,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),

  [_NAVIGATE] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, LNSTART, KC_UP,   LNEND,   XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, TD(LNK),                   XXXXXXX, KC_LSFT, KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, WNDPREV, XXXXXXX, WNDNEXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F13,  KC_F14,  KC_F15,  XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),

  [_SLAYER] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SL_PU,
    XXXXXXX, XXXXXXX, SL_W,    XXXXXXX, SL_P,    XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SL_PD,
