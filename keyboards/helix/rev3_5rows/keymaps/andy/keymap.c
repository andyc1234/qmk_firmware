...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SHORTCUT] = LAYOUT(
    ...
    KC_CAPS, XXXXXXX, XXXXXXX, FINDER,  XXXXXXX, CHROME,                   XXXXXXX, NOTES,   XXXXXXX, ITERM,   OUTLOOK, XXXXXXX,
  ...
  [_NUMSYM] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, KC_TILD, XXXXXXX, KC_0,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_SLAYER] = LAYOUT(
    XXXXXXX, SL_1,    SL_2,    SL_3,    SL_4,    SL_5,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SL_PU,
