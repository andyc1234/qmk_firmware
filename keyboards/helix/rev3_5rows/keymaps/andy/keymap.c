...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LEFT, KC_RGHT, PST_FND, CPY_CUT, TAB_NUM, SPC_CTL, BSP_ALT, TMUX,    ENT_NAV, NUM_SYM, TOG_WIN, SLAYER, KC_DOWN, KC_UP
  ),
  ...
  [_SHORTCUT] = LAYOUT(
    ...
    KC_CAPS, XXXXXXX, XXXXXXX, SLACK,   XXXXXXX, CHROME,                   XXXXXXX, NOTES,   EXCEL,   ITERM,   OUTLOOK, XXXXXXX,
  ...
  [_SLAYER] = LAYOUT(
    ...
    XXXXXXX, SL_A,    XXXXXXX, XXXXXXX, XXXXXXX, SL_G,                      SL_M,    SL_N,    SL_E,    SL_I,    XXXXXXX, XXXXXXX,
    XXXXXXX, SL_Z,    XXXXXXX, SL_C,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SL_H,    SL_CO,   XXXXXXX, XXXXXXX, XXXXXXX,
