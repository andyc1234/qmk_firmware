...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCMD, Z_SFT,   KC_X,    KC_C,    KC_D,    KC_B,    TD(APP), TD(TAB), KC_K,    KC_H,    KC_COMM, KC_DOT, SLH_SFT, KC_RCMD,
                      PST_FND, CPY_CUT, TAB_NUM, SPC_CTL, BSP_ALT, TD(MUX), ENT_NAV, NUM_SYM, TOG_WIN, SLAYER
  ),
  ...
  [_SLAYER] = LAYOUT(
    RESET,   SL_1,    SL_2,    SL_3,    SL_4,    SL_5,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
